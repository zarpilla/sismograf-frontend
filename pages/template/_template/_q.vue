...
export default {
  ...
  async asyncData({ $axios, app, error, store }) {
    ...
    const appq = `/applications?filters[slug][$eq]=${process.env.application}-${app.i18n.locale}&populate=footer&populate=footer.logo1&populate=footer.logo2&populate=footer.logo3&populate=guide_more_image&locale=${app.i18n.locale}`;
