  ...
  <div class="fullpage-container">
    <no-ssr>
      <full-page ref="fullpage" :options="options" id="fullpage">
        ...
        <template v-for="(labelCategory, lci) in labelQuestions">
          <div
            v-bind:key="lci"
...
export default {
  ...
  computed: {
    ...
    labelQuestions() {
      if (
        this.questionnaire.attributes.label_categories &&
        this.questionnaire.attributes.label_categories.data
      ) {
        return _.sortBy(
          this.questionnaire.attributes.label_categories.data,
          "attributes.order"
  ...
  async asyncData({ $axios, app, error, store }) {
    ...
    const appq = `/applications?filters[slug][$eq]=${process.env.application}-${app.i18n.locale}&populate=footer&populate=footer.logo1&populate=footer.logo2&populate=footer.logo3&populate=footer.logo4&populate=footer.logo5&populate=guide_more_image&locale=${app.i18n.locale}`;
