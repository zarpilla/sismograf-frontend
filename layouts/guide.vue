...
export default {
  ...
  async fetch() {
    var { data } = await this.$axios.get(
      `/applications?filters[slug][$eq]=${process.env.application}-${this.$i18n.locale}&populate=footer&populate=footer.logo1&populate=footer.logo2&populate=footer.logo3&populate=footer.logo4&populate=footer.logo5&populate=guide_more_image&locale=${this.$i18n.locale}&populate=guide_template`,
      {}
    );
