    ...
    <section>
      <div class="sismograf-report">
        <b-row>
          ...
          <b-col md="7">
            <div id="svg" class="svg svg-result" v-if="analysis"></div>
          </b-col>
          <b-col md="3">
            <div class="d-flex">
...
export default {
  ...
  computed: {
    ...
    domainsData() {
      return this.chartSummary.domains.map((d) => {
  ...
  methods: {
    async draw() {
      ...
      const bgrColor2 = (value) => {
        const idx = parseInt(value / 12.5);
        return _.reverse(this.colors06)[idx];
      };

      const bgrColor03 = (value) => {
        const idx = parseInt(value / 12.5);
        return _.reverse(this.colors03)[idx];
      };
      ...
      var svg = d3.select(".svg-result").append("svg").append("g");
      ...
      console.log("principlesValues()", principlesValues());
    ...
    */
    ...
    toLevel(value) {
      const level = this.levels[this.$i18n.locale].find(
